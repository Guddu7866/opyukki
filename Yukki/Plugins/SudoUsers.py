...
@app.on_message(filters.command("broadcastt_pin") & filters.user(SUDOERS))
...
@app.on_message(filters.command("broadcastt_pin_loud") & filters.user(SUDOERS))
...
@app.on_message(filters.command("broadcastt") & filters.user(SUDOERS))
